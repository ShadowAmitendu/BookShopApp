        ...
        <div class="bg-white border-4 border-black p-10 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden">
            ...
            <div class="mb-8">
                <div class="w-16 h-16 bg-blue-600 border-4 border-black mb-6 flex items-center justify-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="square" stroke-linejoin="round" stroke-width="3"
                              d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                    </svg>
                </div>
                <h1 class="text-4xl font-black uppercase tracking-tighter">Check your <br/><span class="text-blue-600">Inbox.</span>
                </h1>
                <p class="text-gray-500 font-bold uppercase text-[10px] mt-2 tracking-[0.2em]">We've sent a verification
                    link to:</p>
            ...
            <div class="space-y-6">
                <p class="text-sm font-bold text-gray-600 leading-relaxed">
                    Click the link in the email to activate your account. If you don't see it, check your <span
                        class="bg-yellow-200 px-1">spam folder</span>.
                </p>
