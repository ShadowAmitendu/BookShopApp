        ...
        <main class="flex-grow flex items-center justify-center px-4 py-12">
            <div class="max-w-md w-full">
                <div class="bg-white border-4 border-black p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
                    <div class="mb-8">
                        <h1 class="text-4xl font-black uppercase tracking-tighter">Join the <br/><span class="text-pink-500">Club.</span></h1>
                        <p class="text-gray-500 font-bold uppercase text-xs mt-2 tracking-widest">Create your account in seconds</p>
                    </div>
                    ...
                    <form action="${pageContext.request.contextPath}/signup" method="POST" class="space-y-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="role" class="w-full border-2 border-black p-3 focus:bg-yellow-50 outline-none transition-colors appearance-none bg-white">
