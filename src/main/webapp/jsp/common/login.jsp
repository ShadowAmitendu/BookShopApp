        ...
        <main class="flex-grow flex items-center justify-center px-4 py-12">
            <div class="max-w-md w-full">
                <div class="bg-white border-4 border-black p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
                    <div class="mb-8">
                        <h1 class="text-4xl font-black uppercase tracking-tighter">Welcome <br/><span class="text-blue-600">Back.</span></h1>
                        <p class="text-gray-500 font-bold uppercase text-xs mt-2 tracking-widest">Enter your credentials to continue</p>
                    </div>
