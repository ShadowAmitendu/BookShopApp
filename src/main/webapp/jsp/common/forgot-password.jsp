            ...
            <div class="max-w-md w-full">
                ...
                <div class="bg-white border-4 border-black p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
                    <div class="mb-8">
                        ...
                        <h1 class="text-4xl font-black uppercase tracking-tighter">Lost your <br/><span class="text-blue-600">Key?</span></h1>
                        <p class="text-gray-500 font-bold uppercase text-xs mt-2 tracking-widest">Enter your email and we'll send a reset link.</p>
                    </div>
                    ...
                    <div class="mt-8 pt-6 border-t-2 border-gray-100 text-center">
                        <a href="login" class="text-sm font-black uppercase tracking-widest hover:text-blue-600 transition-colors">
                            ← Back to Login
                        </a>
                    </div>
                </div>
                ...
                <div class="mt-6 text-center opacity-50">
                    <p class="text-[10px] font-black uppercase tracking-[0.2em]">Check your spam folder if the link doesn't arrive!</p>
                </div>
